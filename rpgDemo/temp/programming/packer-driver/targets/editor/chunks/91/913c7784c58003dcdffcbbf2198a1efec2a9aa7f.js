  ...
  return {
    ...
    execute: function () {
      ...
      _export("PlayerControl", PlayerControl = (_dec = ccclass('PlayerControl'), _dec2 = property(Number), _dec(_class = (_class2 = class PlayerControl extends Component {
        ...
        fixedUpdate(fixedDt) {
          let movement = new Vec2(this._moveDirection.x * this.moveSpeed * fixedDt, this._moveDirection.y * this.moveSpeed * fixedDt); //console.log("当前刚体运动的向量值："+movement.x+","+movement.y);
